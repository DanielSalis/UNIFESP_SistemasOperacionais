 ...
 *				enqueue					     * 
 *===========================================================================*/
/* função enqueue de minix/kernel/proc.c */
void enqueue(
 ...
 */
	...
	{
		if (rp->p_quantum_size_ms < rdy_head[q]->p_cpu_time_left)
		{
			rp->p_nextready = rdy_head[q];
			rdy_head[q] = rp;
		}
		else if (rp->p_quantum_size_ms > rdy_tail[q]->p_cpu_time_left)
		...
		{
			register struct proc *ant, *prox;
			ant = rdy_head[q];
			prox = ant->p_nextready;
			while (prox)
			{
				if (rp->p_quantum_size_ms < prox->p_cpu_time_left && rp->p_quantum_size_ms > ant->p_cpu_time_left)
				{
					rp->p_nextready = prox;
					ant->p_nextready = rp;
					break;
